...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/painel-interno/integracoes/infinitepay', label: 'InfinitePay', icon: <><path d="M4 7h16v10H4z" /><path d="M4 11h16" /><path d="M8 15h3" /></> },
      { to: '/painel-interno/comunicacao/email', label: 'E-mail', icon: <><path d="M4 6h16v12H4z" /><path d="m4 8 8 6 8-6" /></> },
