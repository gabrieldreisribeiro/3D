...
function Header() {
  ...
  return (
    <header className="public-header sticky top-0 z-50 border-b border-[#E6EAF0] bg-white shadow-[0_3px_14px_rgba(15,23,42,0.06)]">
      <div className="public-header-main mx-auto grid w-full max-w-7xl grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 px-3 py-2 sm:gap-4 sm:px-6 lg:h-[74px] lg:px-8 lg:py-0">
        <Link to={`${previewPrefix}/`} className="public-header-logo flex min-w-[62px] items-center sm:min-w-[124px]">
          {logoUrl ? (
            <img
              src={logoUrl}
              alt="Logo da loja"
        ...
        <form onSubmit={onSearch} className="public-header-search w-full">
        ...
        <div className="public-header-actions flex items-center gap-1 sm:gap-2">
          <NavLink
            to={`${previewPrefix}/`}
            end
            className={({ isActive }) =>
      ...
      <div className="public-header-nav border-t border-[#E6EAF0] bg-[#F9FAFB]">
